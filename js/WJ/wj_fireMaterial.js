...
function markerClick(marker,result){
    ...
    '<a href="#" class="ml-5" style="display: block;width:120px;height:28px;background-color:#addc9d;color:#fff;text-align: center;line-height:28px;font-size:14px;border-radius:4px;margin:8px auto 0 auto;">详情</a></div>'
