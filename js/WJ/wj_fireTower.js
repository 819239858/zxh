...
function markerClick(marker,result){
    marker.content='<div style="padding-left:5px;border-radius:6px;">'+
    ...
    '<p style="color:#030303;font-size:14px;">建设年份:<span style="color:#999da8;margin-left:6px;">'+result.create_year+'</span></p>'+
    '<p style="color:#030303;font-size:14px;">录入时间:<span style="color:#999da8;margin-left:6px;">'+result.input_time+'</span></p>'+
...
// 新增弹框
function new_office() {
    var add_resources ="<ul class=\"form_sub form_sub_release\"><li><label>区域<i style='color:red'>*</i></label><select id=\"province\" class=\"remove_disabled\" onchange=\"callback(value,this)\"></select><select id=\"city_two\" class=\"remove_disabled\" onchange=\"callback(value,this)\"></select><select id=\"area\" class=\"remove_disabled\"></select><label>位置<i style='color:red'>*</i></label><input type=\"text\" class=\"form-control form-boxed\" disabled id=\"latLngs\"  style=\"margin-right:2px;width:135px;\"><input class=\"enter_map_two\" type=\"button\" value=\"进入地图\" onclick=\"sessionStorage.setItem('hidebtn','2');layer.open({type: 2,title: '选中地图',shadeClose: false,shade: 0.8,area: ['700px', '450px;'],content: 'map.html',cancel: function(){$('#latLngs').val(localStorage.getItem('site'));sessionStorage.removeItem('hidebtn');}})\" /></li><li><label>建设年份<i style='color:red'>*</i></label><input type=\"text\" id=\"buildTime\" onclick=\"WdatePicker({dateFmt:'yyyy-MM',maxDate:'%y-%M'})\" class=\"Wdate remove_disabled form-control\" /><label>成立时间<i style='color:red'>*</i></label><input type=\"text\" class=\"Wdate remove_disabled form-control\" value=\"\" id=\"established_time\" onclick=\"WdatePicker({dateFmt:'yyyy-MM-dd',maxDate:'%y-%M-%d'})\"></li><li><label>管理者<i style='color:red'>*</i></label><input type=\"text\" class=\"form-control form-boxed\" value=\"\" id=\"manage\"><label>电话<i style='color:red'>*</i></label><input type=\"text\" class=\"form-control form-boxed\" value=\"\" id=\"phone\"></li><li><label>高度(米)<i style='color:red'>*</i></label><input type=\"text\" class=\"form-control form-boxed\" value=\"\" id=\"height\"><label>建设海拔(米)<i style='color:red'>*</i></label><input type=\"text\" class=\"form-control form-boxed\" value=\"\" id=\"altitude\"></li><li><label>覆盖范围(公里)<i style='color:red'>*</i></label><input type=\"text\" class=\"form-control form-boxed\" value=\"\" id=\"radius\"></li><li><label>装载设备<i style='color:red'>*</i></label><textarea class=\"form-control form-boxed remove_disabled\" id=\"eqps\"></textarea><label>描述</label><textarea class=\"form-control form-boxed remove_disabled\" id=\"desc\"></textarea></li><li>" +
        "<label>图片</label><input type=\"file\" id=\"photoName1\" class=\"upFileBtn\"  accept=\"image/png,image/jpg,image/gif,image/JPEG\"><img class=\"fileInput\" src=\"img/lqz/upimg.png\" onclick=\"$('#photoName1').click()\"><div id=\"imgBox\" style=\"display:inline-block\"></div></li></ul>"
    ...
    layer.confirm(''+add_resources+'', {
		...
		if (region!=''&&location!=''&&create_year!=''&&height!=''&&create_elevation!=''&&administrator!=''&&phone!=''&&established_time!='') {
			sendAjax({
				"url":"fire/fire_watchtower/addFireWatchtower",
				"data":{"region":region,"location":location,"create_year":create_year,
                    "loading_equipment":loading_equipment,"coverage_area":coverage_area,
                    "describe":describe,"team_image":imgName,"administrator":administrator,"phone":phone,
                    "height":height,"create_elevation":create_elevation,"established_time":established_time},
            ...
            if (element.code=="s_ok"){
                ...
                if(userLevel!='1'){
                    layer.open({
                        ...
                        "<li><label>装载设备<i style='color:red'>*</i></label><textarea class=\"form-control form-boxed remove_disabled\" id=\"eqps\" disabled></textarea><label>描述</label><textarea class=\"form-control form-boxed remove_disabled\" id=\"desc\" disabled></textarea></li><li><label>图片</label><input type=\"file\" id=\"photoName2\" class=\"upFileBtn\"  accept=\"image/png,image/jpg,image/gif,image/JPEG\" style=\"display:none\"> <img class=\"fileInput\" src=\"img/lqz/upimg.png\" onclick=\"$('#photoName2').click()\" style=\"display:none\"><div id=\"imgBox1\" style=\"display:inline-block\"></div></li><li class=\"background_user_information\">" +
                    ...
                    layer.open({
                        ...
                        shadeClose: true,
                        content:"<ul class=\"form_sub form_sub_release\"><li><label>区域<i style='color:red'>*</i></label><select id=\"province\" class=\"remove_disabled\" onchange=\"callback(value,this)\" disabled style=\"background-color:#f2f2f2\"></select><select id=\"city_two\" class=\"remove_disabled\" onchange=\"callback(value,this)\" disabled style=\"background-color:#f2f2f2\"></select><select id=\"area\" class=\"remove_disabled\" disabled style=\"background-color:#f2f2f2\"></select>" +
                        "<label>位置<i style='color:red'>*</i></label><input type=\"text\" class=\"form-control form-boxed \" disabled id=\"latLngs\"  style=\"margin-right:2px;width:135px;\"><input class=\"enter_map_two\" type=\"button\" style=\"display:none\" value=\"进入地图\" onclick=\"sessionStorage.setItem('hidebtn','2');layer.open({type: 2,title: '选中地图',shadeClose: false,shade: 0.8,area: ['700px', '450px;'],content: 'map.html',cancel: function(){$('#latLngs').val(localStorage.getItem('site'));sessionStorage.removeItem('hidebtn');}})\" /></li><li><label>建设年份<i style='color:red'>*</i></label><input type=\"text\" id=\"buildTime\" disabled onclick=\"WdatePicker({dateFmt:'yyyy-MM'})\" class=\"Wdate remove_disabled form-control\" /><label>录入时间<i style='color:red'>*</i></label><input type=\"text\" disabled id=\"inputTime\" onclick=\"WdatePicker({dateFmt:'yyyy-MM-dd'})\" class=\"Wdate form-control\"/></li><li><label>管理者<i style='color:red'>*</i></label><input type=\"text\" class=\"form-control form-boxed remove_disabled\" value=\"\" id=\"manage\" disabled><label>电话<i style='color:red'>*</i></label><input type=\"text\" class=\"form-control form-boxed remove_disabled\" value=\"\" id=\"phone\" disabled></li><li><label>高度(米)<i style='color:red'>*</i></label><input type=\"text\" class=\"form-control form-boxed remove_disabled\" value=\"\" id=\"height\" disabled>" +
                        "<label>建设海拔(米)<i style='color:red'>*</i></label><input type=\"text\" class=\"form-control form-boxed remove_disabled\" value=\"\" id=\"altitude\" disabled></li><li><label>覆盖范围(公里)<i style='color:red'>*</i></label><input type=\"text\" class=\"form-control form-boxed remove_disabled\" value=\"\" id=\"radius\" disabled><label>成立时间<i style='color:red'>*</i></label><input type=\"text\" class=\"Wdate remove_disabled form-control\" value=\"\" id=\"established_time\" onclick=\"WdatePicker({dateFmt:'yyyy-MM'})\" disabled></li>" +
                        ...
                        "<li class=\"background_user_information\">" +
...
function delete_data(fireid) {
	layer.confirm('确定要删除吗？',{
		...
		sendAjax({
            "url":"fire/fire_watchtower/delFireWatchtower",
...
query();
function query() {
    //$("#city").val()==''||$("#city").val()==undefined?region=$("#hot_city").val():$("#village").val()==''||$("#village").val()==undefined?region=$("#city").val():region=$("#village").val();
    ...
    addBeiJing();
	sendAjax({
		"url":"fire/fire_watchtower/getFireWatchtowerList",
					...
					backFn:function(p){
                        ...
                        "callback":function(data){
							...
							for(var i=0;i<result.length;i++){
							    if(userLevel!="1") {
                                    $("#complete_report").append("<tr><td>" + result[i].region_name + "</td><td>" + result[i].location + "</td>><td>" + result[i].height + "</td><td>" + result[i].create_elevation + "</td><td>" + result[i].coverage_area + "</td><td>" + result[i].create_year + "</td><td>" + result[i].established_time + "</td><td><a class='mr-5'>详情</a> <a onclick=\"delete_data(" + result[i].id + ")\">删除</a></td></tr>");
                                }else{
                                    $("#complete_report").append("<tr><td>" + result[i].region_name + "</td><td>" + result[i].location + "</td>><td>" + result[i].height + "</td><td>" + result[i].create_elevation + "</td><td>" + result[i].coverage_area + "</td><td>" + result[i].create_year + "</td><td>" + result[i].established_time + "</td><td><a class='mr-5'>详情</a></td></tr>");
                                }
							}
    ...
    // 数据统计
    sendAjax({
        "url":"fire/fire_watchtower/statisticsFireWatchtower",
        "data":{},"callback":function(data){
            ...
            if (data.code=="s_ok") {
                ...
                for(var i=0;i<result.length;i++){
                    $("#complete_report_two").append("<tr><td>" + result[i].name + "</td><td>" + result[i].quantity + "</td></tr>");
                };
            }else{
                layer.msg(data.var);
            }
