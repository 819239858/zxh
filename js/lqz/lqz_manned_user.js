...
function refresh1() {
    ...
    sendAjax({
        ...
        "data":{"current_page": 1, "region":city,"name": user_name, "mid":5,"per_page":20,"examine":1 },"callback":function(result){
            ...
            if (result.code!="s_ok") {
                ...
                $(".complete_page").createPage({
                    ...
                    backFn: function(p) {
                        sendAjax({
                            "url":"fire/user/getUserList",
                            "data":{"current_page":p,"region":city,"name":user_name,"mid":5,"per_page":20,"examine":1},"callback":function(result){
...
function news_user(e) {
    ...
    layer.confirm('' + news_user + '', {
        ...
        var airplane_model=$("#planeNo").val();
        ...
        if (name!=''&& tel!= '' && pwd != '' && pwd1 != ''&& job != '' ) {
            sendAjax({
                ...
                "data":{"tel":tel,"password":pwd,"region":region,"name":name,"mids":sum2,"imgHead":imgHead,"job":job,"rid":rid,"airplane_model":airplane_model},"callback":function(data){
...
function disabled_user(fireId) {
    ...
    if (name != '' && rid != '' && pwd!=''&& pwd1 !=''&& imgHead!='') {
        sendAjax({
            ...
            "data":{"uid":fireId,"name":name,"rid":rid,"mids":sum2,"imgHead":imgHead,"job":job,"airplane_model":airplane_model},"callback":function(data){
...
function disable(result) {
    layer.confirm("禁用后该账户无法使用，是否确认？", {
        ...
        sendAjax({
            ...
            "data":{"uids": [result], "mid":5,"status":0 },"callback":function(result){
...
function nodisable(result) {
    layer.confirm("启用后该账户正常使用，是否确认？", {
        ...
        sendAjax({
            "url":"fire/user/editUserStatus",
            "data":{"uids": [result], "mid":5,"status":1 },"callback":function(result){
...
function information(e) {
    ...
    sendAjax({
        "url":"fire/user/getUserList",
        "data":{"current_page": 1, "region":city,"name": user_name, "mid":5,"per_page":20,"examine":0 },
        "callback":function(result){
            var num = '';
            if (result.code!="s_ok") {
                ...
                $(".complete_page1").createPage({
                    ...
                    backFn: function(p) {
                        sendAjax({
                            "url":"fire/user/getUserList",
                            "data":{"current_page":p,"region":city,"name":user_name,"mid":5,"per_page":20,"examine":0},"callback":function(result){
...
function audit() {
    ...
    layer.confirm("已经提交无人机用户注册审核，是否通过?", {
        ...
        sendAjax({
            ...
            "data":{"uids": name_array, "mid":5,"examine":1 },"callback":function(result){
...
$("#report_btn").click(function() {
    if ($(this).text() == "载人机审核信息") {
        ...
        $(this).html("<i class=\"icon-file-alt\"></i>载人机审核信息");
    }
});