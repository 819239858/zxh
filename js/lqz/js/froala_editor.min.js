...
function (a) {
    a.Editable.image_commands = {
        ...
        var b = '<div class="froala-popup froala-image-popup" style="display: none;"><h4><span data-text="true">上传图片</span><span data-text="true">上传中</span><i title="Cancel" class="fa fa-times" id="f-image-close-' + this._id + '"></i></h4>';
        ...
        var c = b.find("img").get(0),
            d = "你确定要删除这张图片吗？";
        if (a.Editable.LANGS[this.options.language] && (d = a.Editable.LANGS[this.options.language].translation[d]), confirm("你确定要删除这张图片吗？")) {
