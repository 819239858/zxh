                ...
                $.ajax({
                    ...
                    success : function(data) {
                        ...
                        if (data.code =="s_ok") {
                            ...
                            $("."+opt.id+"").html("<span style='margin-left:20px;cursor: pointer;white-space: inherit;' onclick=\"wj_remove('"+data.var+"',this)\">"+imgArr.join()+"<i class='icon-remove' style='color:#01dacf;'></i></span>");
